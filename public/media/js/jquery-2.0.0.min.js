...
(function(e, undefined) {
                    ...
                    if (
                        ((t = t instanceof x ? t[0] : t),
                            x.merge(
                                ...
                                x.parseHTML(
                                    r[1],
                                    t && t.nodeType ? t.ownerDocument || t : o, !0
                                )
                            ),
                ...
                return t !== c && 9 === t.nodeType && t.documentElement ?
                    ((c = t),
                        ...
                        (b.getById = at(function(e) {
                            return (
                                (f.appendChild(e).id = y), !t.getElementsByName || !t.getElementsByName(y).length
                            );
                        })),
                        b.getById ?
        ...
        (ut.matchesSelector = function(e, t) {
            if (
                ((e.ownerDocument || e) !== c && l(e),
                    (t = t.replace(U, "='$1']")), !(!b.matchesSelector || !p || (d && d.test(t)) || (h && h.test(t))))
            )
                try {
                    var n = g.call(e, t);
                    if (
    ...
    (x.Callbacks = function(e) {
        ...
        var t,
            ...
            l = function(f) {
                for (
                    t = e.memory && f, n = !0, s = i || 0, i = 0, o = a.length, r = !0; a && o > s; s++
                )
            ...
            c = {
                ...
                fireWith: function(e, t) {
                    return (
                        (t = t || []),
                        (t = [e, t.slice ? t.slice() : t]), !a || (n && !u) || (r ? u.push(t) : l(t)),
                        this
                    );
                },
                fire: function() {
        ...
        trigger: function(t, n, r, i) {
            ...
            if (
                ...
                if (!i && !p.noBubble && !x.isWindow(r)) {
                    for (
                        l = p.delegateType || d, _.test(l + d) || (a = a.parentNode); a; a = a.parentNode
                    )
                        h.push(a), (u = a);
                    u === (r.ownerDocument || o) &&
    ...
    x.fn.extend({
            ...
            domManip: function(e, t, n) {
                ...
                if (
                    ...
                    if (s)
                        for (
                            u = o[o.length - 1].ownerDocument, x.map(o, pt), l = 0; s > l; l++
                        )
                            (a = o[l]),
                            st.test(a.type || "") &&
        ...
        x.extend({
            clone: function(e, t, n) {
                ...
                if (t)
                    if (n)
                        for (
                            o = o || gt(e), s = s || gt(a), r = 0, i = o.length; i > r; r++
                        )
                            dt(o[r], s[r]);
                    else dt(e, a);
                return (
